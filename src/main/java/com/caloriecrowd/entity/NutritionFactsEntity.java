...
public class NutritionFactsEntity {
  ...
  @Column private Double cholesterolMg;

  @Column private Double saturatedFats;

  @Column private Double calciumMg;

  @Column private Double ironFemg;
  @Column private Integer protein;

  @Column private Integer netCarbs;
